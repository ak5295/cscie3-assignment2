...
splitName.onclick = function(){
               ...
               //find the position number of the space between first name and last name
               var position = fullname.indexOf(" ");
               //console.log(position);
               
               //find the first name from start to the position
               firstname = fullname.substr(0, position);
               //console.log(firstname);
               
               //find the last name from the position+1 
